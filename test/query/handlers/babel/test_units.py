...
def get_unit_result(Q):
    def _get_unit_result(
        ...
        clipboard = clipboard if clipboard is not None else name
        return {
            'result': {
                'query': parsed_query,
                'value': value,
...
def currency_amount(Q, data):
    def _currency_amount(
        amount, currency_from, currency_to, quantity, babel=None
    ):
        ...
        amount = '{} {}'.format(amount, currency_to)
        if babel:
            amount = '{} ({})'.format(amount, babel)
        return amount
    ...
    lambda Q: {
        ...
        'results': [
            get_unit_result(Q)(
                ...
                '61.1783 pounds',
                '1 kilogram = 2.20462 pounds • [mass]',
            ),
        ],
    },
    lambda Q: {
    ...
    lambda Q, data: {
        ...
        'results': [
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(10000, 'MXN', 'EUR', False, 'Euro'),
                currency_description(Q, data)('MXN', 'EUR'),
                clipboard=currency_amount(Q, data)(10000, 'MXN', 'EUR', False),
                order=0,
            ...
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(
                    10000, 'MXN', 'USD', False, 'US Dollar'
                ),
                currency_description(Q, data)('MXN', 'USD'),
                clipboard=currency_amount(Q, data)(10000, 'MXN', 'USD', False),
                order=1,
            ...
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(
                    10000, 'MXN', 'CAD', False, 'Canadian Dollar'
                ),
                currency_description(Q, data)('MXN', 'CAD'),
                clipboard=currency_amount(Q, data)(10000, 'MXN', 'CAD', False),
                order=3,
            ...
            get_unit_result(Q)(
                ...
                '10,000.00 MXN (Mexican Peso)',
                '',
                clipboard='10,000.00 MXN',
                order=4,
    ...
    lambda Q, data: {
        ...
        'results': [
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(
                    7.277, 'AMD', 'RON', False, 'Romanian Leu'
                ),
                currency_description(Q, data)('AMD', 'RON'),
                clipboard=currency_amount(Q, data)(7.277, 'AMD', 'RON', False),
                order=0,
    ...
    lambda Q, data: {
        ...
        'results': [
            ...
            get_unit_result(Q)(
                ...
                '100.27 USD (US Dollar)',
                '',
                clipboard='100.27 USD',
                order=1,
                icon=images_dir('flags', 'USD.svg'),
            ),
        ],
    ...
    lambda Q, data: {
        ...
        'results': [
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(
                    0.1, 'BTC', 'CAD', False, 'Canadian Dollar'
                ),
                currency_description(Q, data)('BTC', 'CAD'),
                clipboard=currency_amount(Q, data)(0.1, 'BTC', 'CAD', False),
                order=0,
                icon=images_dir('flags', 'CAD.svg'),
            ),
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(0.1, 'BTC', 'EUR', False, 'Euro'),
                currency_description(Q, data)('BTC', 'EUR'),
                clipboard=currency_amount(Q, data)(0.1, 'BTC', 'EUR', False),
                order=1,
                icon=images_dir('flags', 'EUR.svg'),
            ),
            get_unit_result(Q)(
            ...
            get_unit_result(Q)(
                ...
                currency_amount(Q, data)(
                    0.1, 'BTC', 'AED', False, 'United Arab Emirates Dirham'
                ),
                currency_description(Q, data)('BTC', 'AED'),
                clipboard=currency_amount(Q, data)(0.1, 'BTC', 'AED', False),
                order=3,
    ...
    lambda Q: {
        ...
        'results': [
            get_unit_result(Q)(
                ...
                '100 centimeters',
                '1 meter = 100 centimeters • [length]',
            ),
        ],
    },
    lambda Q: {
